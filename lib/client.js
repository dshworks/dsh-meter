 ...
 */
const WEEKEND_OFFPEAK_FROM = Date.UTC(2026, 7, 22, 16, 0, 0)
 ...
 */
const PEAK_WINDOWS_BEIJING = PEAK_WINDOWS_UTC.map(
 ...
 */
const CACHE_DISCOUNT = Math.floor(
 ...
 */
const beijingClock = epochMs => new Date(epochMs + BEIJING_OFFSET_MS)
 ...
 * @returns {boolean}
 */
function isBeijingWeekend(epochMs) {
...
function localMidnight(epochMs) {
 ...
 */
function localTariffDays(from, days) {
...
function localWeekStart(epochMs) {
 ...
 */
function tariffPrompt(now, saving = {}) {
